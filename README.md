...
- [ ] Explain what a token is used for.
      For the server to remember anything about our interaction with it.

- [ ] What steps can you take in your web apps to keep your data secure?
      Create protected pages, require strong passwords

- [ ] Describe how web servers work.
      Web servers serve web pages it retrieves from your project code upon request.
